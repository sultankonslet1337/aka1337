...
$use_auth = true;
$auth_users = array(
    'aranku' => '$2y$10$JL6bpbc9NC2yESGLDAeXqec0MmX2Otl425y6xBCGlsiGQUuRgeb4m',
);
...
$all_files_size = 0;
$tableTheme = (FM_THEME == "dark") ? "text-white  table-dark" : "bg-white";
?>
...
<head>
    ...
    <style>
        ...
        *,*::before,*::after { box-sizing: border-box;}
        ...
        .inline-actions > a > i { font-size:1em;margin-left:5px;background:#3785c1;color:#ffa700;padding:3px 4px;border-radius:3px; }
    ...
    if (FM_THEME == "dark"): ?>
        <style>
            ...
            body.theme-dark { background-image: url(https://res.cloudinary.com/dr6fjo4ld/image/upload/v1750121225/cybet_hcvqns.jpg); }
            ...
            .theme-dark .inline-actions > a > i { background: #79755e00; }
            .theme-dark .text-white { color: #ff6c00 !important; }
            .theme-dark .table-bordered td, .table-bordered th { border-color: #05003d; }
            ...
            #main-table tr.even { background-color: #ffffff00; }
